...
CREATE TABLE ERCMAIL_MESSAG (BCC_ADDR VARCHAR2(1000), CC_ADDR VARCHAR2(1000), CREATED DATE NOT NULL, DATE_SENT DATE, FROM_ADDR VARCHAR2(255) NOT NULL, ID NUMBER NOT NULL, LAST_MODIFIED DATE NOT NULL, MAIL_STATE_ID CHAR(4) NOT NULL, REPLY_TO_ADDR VARCHAR2(1000), TEXT_ CLOB, TITLE VARCHAR2(255) NOT NULL, TO_ADDR VARCHAR2(1000) NOT NULL, X_MAILER VARCHAR2(255), EXCEPTION_REASON VARCHAR2(1000), IS_READ NUMBER, CONTENT_GZIPPED NUMBER, SHOULD_ARCHIVE_SENT_MAIL NUMBER);
...
CREATE TABLE ERCMAIL_MESSAG_ARCHIVE (BCC_ADDR VARCHAR2(1000), CC_ADDR VARCHAR2(1000), CREATED DATE NOT NULL, DATE_SENT DATE, FROM_ADDR VARCHAR2(255) NOT NULL, ID NUMBER NOT NULL, LAST_MODIFIED DATE NOT NULL, MAIL_STATE_ID CHAR(4) NOT NULL, REPLY_TO_ADDR VARCHAR2(1000), TEXT_ CLOB, TITLE VARCHAR2(255) NOT NULL, TO_ADDR VARCHAR2(1000) NOT NULL, X_MAILER VARCHAR2(255), EXCEPTION_REASON VARCHAR2(1000), IS_READ NUMBER, CONTENT_GZIPPED NUMBER, SHOULD_ARCHIVE_SENT_MAIL NUMBER);

ALTER TABLE ERCMAIL_MESSAG_ARCHIVE ADD PRIMARY KEY (ID);

create sequence ERCMAIL_MESSAG_ARCHIVE_SEQ;
