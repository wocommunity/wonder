...
public class ERXCustomObject extends EOCustomObject implements ERXGuardedObjectInterface, ERXGeneratesPrimaryKeyInterface {
    ...
    */
     ...
     * are created and use ERXCustomObjects or subclasses need to have a delegate
    ...
    /**
     * Overrides the EOCustomObject's implementation to
     ...
     * <com.foo.User pk:"50">
     * EOCustomObject's implementation is preserved in the
    ...
    /**
        * @deprecated use {@link ERXCustomObject#isNewObject() ERXCustomObject#isNewObject}
     */
