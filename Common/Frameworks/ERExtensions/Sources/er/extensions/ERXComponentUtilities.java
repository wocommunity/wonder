...
public class ERXComponentUtilities {
	 ...
	 *            the context
	 */
	public static void appendHtmlAttributes(NSDictionary associations, WOResponse response, WOContext context) {
	 ...
	 */
	public static void appendHtmlAttributes(NSDictionary associations, WOResponse response, WOComponent component) {
		for (Enumeration keyEnum = associations.keyEnumerator(); keyEnum.hasMoreElements();) {
			String key = (String)keyEnum.nextElement();
