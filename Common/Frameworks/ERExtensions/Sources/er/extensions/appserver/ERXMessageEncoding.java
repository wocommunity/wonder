...
public class ERXMessageEncoding implements Serializable {
    ...
    public ERXMessageEncoding(NSArray preferredLanguages) {
        _encoding = null;
        NSArray availableLanguages = availableLanguages();
        
        Enumeration e = preferredLanguages.objectEnumerator();
        while (e.hasMoreElements()) {
            String aPreferredLanguage = (String)e.nextElement();
            if (availableLanguages.containsObject(aPreferredLanguage)) {
                _encoding = defaultEncodingForLanguage(aPreferredLanguage);
                break;
            }
        }
        if (_encoding == null) 
