...
public class ERXBatchFetchUtilities {
	 ...
	 */
    public static void batchFetch(NSArray sourceObjects, ERXKey<?>... keys) {
    ...
    public static void batchFetch(EOEnterpriseObject sourceObject, NSArray keypaths, boolean skipFaultedSourceObjects) {
    	ERXBatchFetchUtilities.batchFetch(new NSArray(sourceObject), keypaths, skipFaultedSourceObjects);
    }
    ...
    public static void batchFetch(NSArray sourceObjects, String keypath, boolean skipFaultedSourceObjects) {
    	ERXBatchFetchUtilities.batchFetch(sourceObjects, new NSArray(keypath), skipFaultedSourceObjects);
    }
