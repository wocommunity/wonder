...
public class ERXSwitchEmbeddedPage extends WODynamicElement {
	...
	public ERXSwitchEmbeddedPage(String name, NSDictionary associations, WOElement template) {
		super(null, null, null);
		_initialComponentName = (WOAssociation)associations.objectForKey("initialComponentName");
