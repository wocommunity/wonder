...
// Generated by the WOLips Templateengine Plug-in at Sep 20, 2007 5:57:01 PM
...
public class ERXDirectActionBatchNavigationBar extends ERXStatelessComponent {
    ...
    public NSArray<NSDictionary<String, Object>> batchNumbers () {
    	...
    	if (this.batchNumbers == null) {
	    	...
	    	int tmp = currentBatchIndex % 9; if (tmp == 0) tmp = 9;
	    	
	    	int batchIndex = currentBatchIndex - tmp + 1;
	    	int maxPages = numberOfObjects / batchSize + 1;
    ...
    public Integer lastBatch () {
    	return (numberOfObjects().intValue() / batchSize()) + 1;
    }
    ...
    public boolean isLastBatch () {
    	return this.currentBatchIndex().intValue() == (numberOfObjects().intValue() / batchSize()) + 1; 
    }
