...
public abstract class ERXComponent extends WOComponent {
	...
	protected void _includeCSSResources(WOResponse response, WOContext context) {
		...
		NSArray additionalCSSFiles = additionalCSSFiles();
		if (additionalCSSFiles != null) {
			...
			String frameworkName = _frameworkName();
			for (Enumeration cssFilesEnum = additionalCSSFiles.objectEnumerator(); cssFilesEnum.hasMoreElements();) {
			    String additionalCSSFile = (String)cssFilesEnum.nextElement();
	...
	protected void _includeJavascriptResources(WOResponse response, WOContext context) {
		...
		NSArray additionalJavascriptFiles = additionalJavascriptFiles();
		if (additionalJavascriptFiles != null) {
			...
			String frameworkName = _frameworkName();
			for (Enumeration javascriptFilesEnum = additionalJavascriptFiles.objectEnumerator(); javascriptFilesEnum.hasMoreElements();) {
			    String additionalJavascriptFile = (String)javascriptFilesEnum.nextElement();
	 ...
	 */
	protected NSArray additionalCSSFiles() {
		return null;
	}
	 ...
	 */
	protected NSArray additionalJavascriptFiles() {
		return null;
	}
