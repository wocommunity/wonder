...
public class ERXPatcher  {
    ...
    public static class DynamicElementsPatches {
        ...
        *  </pre>
        ...
        /** This method adds missing quotes to the given attribute string.
            * E.g. <code>type=text name=&quot;mytext&quot;</code> will be corrected to
            * <code>type=&quot;text&quot; name=&quot;mytext&quot;</code>
            *
            * @param atts a string of attributes.
            *
    ...
    /* the rest is shamelessly copied over from jtidy, but I put it here to avoid having to add it to ERJars for the moment */
    ...
    public static class EntityTable
    {
        ...
        private static Entity[] entities
            = { new Entity("nbsp", (int) 160), new Entity("iexcl", (int) 161),
                new Entity("cent", (int) 162), new Entity("pound", (int) 163),
                new Entity("curren", (int) 164), new Entity("yen", (int) 165),
                new Entity("brvbar", (int) 166), new Entity("sect", (int) 167),
                new Entity("uml", (int) 168), new Entity("copy", (int) 169),
                new Entity("ordf", (int) 170), new Entity("laquo", (int) 171),
                new Entity("not", (int) 172), new Entity("shy", (int) 173),
                new Entity("reg", (int) 174), new Entity("macr", (int) 175),
                new Entity("deg", (int) 176), new Entity("plusmn", (int) 177),
                new Entity("sup2", (int) 178), new Entity("sup3", (int) 179),
                new Entity("acute", (int) 180), new Entity("micro", (int) 181),
                new Entity("para", (int) 182), new Entity("middot", (int) 183),
                new Entity("cedil", (int) 184), new Entity("sup1", (int) 185),
                new Entity("ordm", (int) 186), new Entity("raquo", (int) 187),
                new Entity("frac14", (int) 188), new Entity("frac12", (int) 189),
                new Entity("frac34", (int) 190), new Entity("iquest", (int) 191),
                new Entity("Agrave", (int) 192), new Entity("Aacute", (int) 193),
                new Entity("Acirc", (int) 194), new Entity("Atilde", (int) 195),
                new Entity("Auml", (int) 196), new Entity("Aring", (int) 197),
                new Entity("AElig", (int) 198), new Entity("Ccedil", (int) 199),
                new Entity("Egrave", (int) 200), new Entity("Eacute", (int) 201),
                new Entity("Ecirc", (int) 202), new Entity("Euml", (int) 203),
                new Entity("Igrave", (int) 204), new Entity("Iacute", (int) 205),
                new Entity("Icirc", (int) 206), new Entity("Iuml", (int) 207),
                new Entity("ETH", (int) 208), new Entity("Ntilde", (int) 209),
                new Entity("Ograve", (int) 210), new Entity("Oacute", (int) 211),
                new Entity("Ocirc", (int) 212), new Entity("Otilde", (int) 213),
                new Entity("Ouml", (int) 214), new Entity("times", (int) 215),
                new Entity("Oslash", (int) 216), new Entity("Ugrave", (int) 217),
                new Entity("Uacute", (int) 218), new Entity("Ucirc", (int) 219),
                new Entity("Uuml", (int) 220), new Entity("Yacute", (int) 221),
                new Entity("THORN", (int) 222), new Entity("szlig", (int) 223),
                new Entity("agrave", (int) 224), new Entity("aacute", (int) 225),
                new Entity("acirc", (int) 226), new Entity("atilde", (int) 227),
                new Entity("auml", (int) 228), new Entity("aring", (int) 229),
                new Entity("aelig", (int) 230), new Entity("ccedil", (int) 231),
                new Entity("egrave", (int) 232), new Entity("eacute", (int) 233),
                new Entity("ecirc", (int) 234), new Entity("euml", (int) 235),
                new Entity("igrave", (int) 236), new Entity("iacute", (int) 237),
                new Entity("icirc", (int) 238), new Entity("iuml", (int) 239),
                new Entity("eth", (int) 240), new Entity("ntilde", (int) 241),
                new Entity("ograve", (int) 242), new Entity("oacute", (int) 243),
                new Entity("ocirc", (int) 244), new Entity("otilde", (int) 245),
                new Entity("ouml", (int) 246), new Entity("divide", (int) 247),
                new Entity("oslash", (int) 248), new Entity("ugrave", (int) 249),
                new Entity("uacute", (int) 250), new Entity("ucirc", (int) 251),
                new Entity("uuml", (int) 252), new Entity("yacute", (int) 253),
                new Entity("thorn", (int) 254), new Entity("yuml", (int) 255),
                new Entity("fnof", (int) 402), new Entity("Alpha", (int) 913),
                new Entity("Beta", (int) 914), new Entity("Gamma", (int) 915),
                new Entity("Delta", (int) 916), new Entity("Epsilon", (int) 917),
                new Entity("Zeta", (int) 918), new Entity("Eta", (int) 919),
                new Entity("Theta", (int) 920), new Entity("Iota", (int) 921),
                new Entity("Kappa", (int) 922), new Entity("Lambda", (int) 923),
                new Entity("Mu", (int) 924), new Entity("Nu", (int) 925),
                new Entity("Xi", (int) 926), new Entity("Omicron", (int) 927),
                new Entity("Pi", (int) 928), new Entity("Rho", (int) 929),
                new Entity("Sigma", (int) 931), new Entity("Tau", (int) 932),
                new Entity("Upsilon", (int) 933), new Entity("Phi", (int) 934),
                new Entity("Chi", (int) 935), new Entity("Psi", (int) 936),
                new Entity("Omega", (int) 937), new Entity("alpha", (int) 945),
                new Entity("beta", (int) 946), new Entity("gamma", (int) 947),
                new Entity("delta", (int) 948), new Entity("epsilon", (int) 949),
                new Entity("zeta", (int) 950), new Entity("eta", (int) 951),
                new Entity("theta", (int) 952), new Entity("iota", (int) 953),
                new Entity("kappa", (int) 954), new Entity("lambda", (int) 955),
                new Entity("mu", (int) 956), new Entity("nu", (int) 957),
                new Entity("xi", (int) 958), new Entity("omicron", (int) 959),
                new Entity("pi", (int) 960), new Entity("rho", (int) 961),
                new Entity("sigmaf", (int) 962), new Entity("sigma", (int) 963),
                new Entity("tau", (int) 964), new Entity("upsilon", (int) 965),
                new Entity("phi", (int) 966), new Entity("chi", (int) 967),
                new Entity("psi", (int) 968), new Entity("omega", (int) 969),
                new Entity("thetasym", (int) 977), new Entity("upsih", (int) 978),
                new Entity("piv", (int) 982), new Entity("bull", (int) 8226),
                new Entity("hellip", (int) 8230), new Entity("prime", (int) 8242),
                new Entity("Prime", (int) 8243), new Entity("oline", (int) 8254),
                new Entity("frasl", (int) 8260), new Entity("weierp", (int) 8472),
                new Entity("image", (int) 8465), new Entity("real", (int) 8476),
                new Entity("trade", (int) 8482), new Entity("alefsym", (int) 8501),
                new Entity("larr", (int) 8592), new Entity("uarr", (int) 8593),
                new Entity("rarr", (int) 8594), new Entity("darr", (int) 8595),
                new Entity("harr", (int) 8596), new Entity("crarr", (int) 8629),
                new Entity("lArr", (int) 8656), new Entity("uArr", (int) 8657),
                new Entity("rArr", (int) 8658), new Entity("dArr", (int) 8659),
                new Entity("hArr", (int) 8660), new Entity("forall", (int) 8704),
                new Entity("part", (int) 8706), new Entity("exist", (int) 8707),
                new Entity("empty", (int) 8709), new Entity("nabla", (int) 8711),
                new Entity("isin", (int) 8712), new Entity("notin", (int) 8713),
                new Entity("ni", (int) 8715), new Entity("prod", (int) 8719),
                new Entity("sum", (int) 8721), new Entity("minus", (int) 8722),
                new Entity("lowast", (int) 8727), new Entity("radic", (int) 8730),
                new Entity("prop", (int) 8733), new Entity("infin", (int) 8734),
                new Entity("ang", (int) 8736), new Entity("and", (int) 8743),
                new Entity("or", (int) 8744), new Entity("cap", (int) 8745),
                new Entity("cup", (int) 8746), new Entity("int", (int) 8747),
                new Entity("there4", (int) 8756), new Entity("sim", (int) 8764),
                new Entity("cong", (int) 8773), new Entity("asymp", (int) 8776),
                new Entity("ne", (int) 8800), new Entity("equiv", (int) 8801),
                new Entity("le", (int) 8804), new Entity("ge", (int) 8805),
                new Entity("sub", (int) 8834), new Entity("sup", (int) 8835),
                new Entity("nsub", (int) 8836), new Entity("sube", (int) 8838),
                new Entity("supe", (int) 8839), new Entity("oplus", (int) 8853),
                new Entity("otimes", (int) 8855), new Entity("perp", (int) 8869),
                new Entity("sdot", (int) 8901), new Entity("lceil", (int) 8968),
                new Entity("rceil", (int) 8969), new Entity("lfloor", (int) 8970),
                new Entity("rfloor", (int) 8971), new Entity("lang", (int) 9001),
                new Entity("rang", (int) 9002), new Entity("loz", (int) 9674),
                new Entity("spades", (int) 9824), new Entity("clubs", (int) 9827),
                new Entity("hearts", (int) 9829), new Entity("diams", (int) 9830),
                new Entity("quot", (int) 34), new Entity("amp", (int) 38),
                new Entity("lt", (int) 60), new Entity("gt", (int) 62),
                new Entity("OElig", (int) 338), new Entity("oelig", (int) 339),
                new Entity("Scaron", (int) 352), new Entity("scaron", (int) 353),
                new Entity("Yuml", (int) 376), new Entity("circ", (int) 710),
                new Entity("tilde", (int) 732), new Entity("ensp", (int) 8194),
                new Entity("emsp", (int) 8195), new Entity("thinsp", (int) 8201),
                new Entity("zwnj", (int) 8204), new Entity("zwj", (int) 8205),
                new Entity("lrm", (int) 8206), new Entity("rlm", (int) 8207),
                new Entity("ndash", (int) 8211), new Entity("mdash", (int) 8212),
                new Entity("lsquo", (int) 8216), new Entity("rsquo", (int) 8217),
                new Entity("sbquo", (int) 8218), new Entity("ldquo", (int) 8220),
                new Entity("rdquo", (int) 8221), new Entity("bdquo", (int) 8222),
                new Entity("dagger", (int) 8224), new Entity("Dagger", (int) 8225),
                new Entity("permil", (int) 8240), new Entity("lsaquo", (int) 8249),
                new Entity("rsaquo", (int) 8250), new Entity("euro", (int) 8364) };
