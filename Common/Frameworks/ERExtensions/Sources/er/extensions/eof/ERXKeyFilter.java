...
public class ERXKeyFilter {
	 ...
	 */
	public NSSet lockedRelationships() {
	...
	public boolean excludes(ERXKey key) {
		return _excludes.containsObject(key);
	}
	...
	public boolean lockedRelationship(ERXKey key) {
		return _lockedRelationships.containsObject(key);
	}
	...
	public String toString() {
		...
		if (_lockedRelationships.count() > 0) {
