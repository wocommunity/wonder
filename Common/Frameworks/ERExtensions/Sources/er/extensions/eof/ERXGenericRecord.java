...
public class ERXGenericRecord extends EOGenericRecord implements ERXGuardedObjectInterface, ERXGeneratesPrimaryKeyInterface {
     ...
     * {@link er.extensions.eof.EOEnterpriseObjectClazz} for more information on this
     * neat design pattern.
     */
    ...
    * which is in turn called by {@link er.extensions.eof.ERXEditingContextDelegate}. The default
    ...
    */
     ...
     * delegate {@link er.extensions.eof.ERXDefaultEditingContextDelegate}.
     ...
     * This is called by {@link er.extensions.eof.ERXDefaultEditingContextDelegate}
	 ...
	 * a delegate set of instance {@link er.extensions.eof.ERXEditingContextDelegate}. These
    ...
    /**
     * Implementation of the interface {@link er.extensions.eof.ERXGeneratesPrimaryKeyInterface}.
     ...
     * a transaction. The delegate {@link er.extensions.eof.ERXDatabaseContextDelegate} is the only class
