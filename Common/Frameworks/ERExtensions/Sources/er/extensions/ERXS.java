...
public class ERXS {
	...
	public static void sort(NSMutableArray array, EOSortOrdering... orderings) {
		EOSortOrdering.sortArrayUsingKeyOrderArray(array, new NSArray(orderings));
	}

	public static void sort(NSMutableArray array, NSArray orderings) {
		EOSortOrdering.sortArrayUsingKeyOrderArray(array, orderings);
	}

	public static NSArray sorted(NSArray array, EOSortOrdering... orderings) {
		return ERXS.sorted(array, new NSArray(orderings));
	}

	@SuppressWarnings("unchecked")
	public static NSArray sorted(NSArray array, NSArray orderings) {
	...
	public static ERXSortOrdering.ERXSortOrderings chain(NSArray... arr) {
	  ERXSortOrdering.ERXSortOrderings result = new ERXSortOrdering.ERXSortOrderings();
		for (NSArray value : arr) {
