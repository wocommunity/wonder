...
class ERXPatternParser extends PatternParser {
    ...
    public void finalizeConverter(char c) {
        switch (c) {
            case '$':
                addConverter(new er.extensions.logging.ERXPatternParser.AppNamePatternConverter(formattingInfo));
                currentLiteral.setLength(0);
                break;
            case '#':
                addConverter(new er.extensions.logging.ERXPatternParser.AdaptorPortNumberConverter(formattingInfo));
                currentLiteral.setLength(0);
                break;
            case '@':
                addConverter(new er.extensions.logging.ERXPatternParser.StackTracePatternConverter(formattingInfo));
                currentLiteral.setLength(0);
                break;
            case 'W':
                addConverter(new er.extensions.logging.ERXPatternParser.AppInfoPatternConverter(formattingInfo, extractOption()));
                currentLiteral.setLength(0);
                break;
            case 'V':
                addConverter(new er.extensions.logging.ERXPatternParser.JavaVMInfoPatternConverter(formattingInfo, extractOption()));
                currentLiteral.setLength(0);
                break;
            case 'T':
                addConverter(new er.extensions.logging.ERXPatternParser.ThreadStoragePatternConverter(formattingInfo, extractOption()));
                currentLiteral.setLength(0);
                break;
            default:
