...
public class ERXWOContext extends ERXAjaxContext implements ERXMutableUserInfoHolderInterface {
	 ...
	 */
	public static NSArray _componentPath(WOContext context) {
		NSMutableArray result = new NSMutableArray();
		if (context != null) {
			WOComponent component = context.component();
			while (component != null) {
	...
	public static String safeIdentifierName(WOContext context, boolean willCache) {
		...
		if (willCache) {
			NSMutableDictionary pageUserInfo = ERXResponseRewriter.pageUserInfo(context);
	 ...
	 * @return the constructed direct action URL
	 */
	public static String directActionUrl(WOContext context, String directActionName, NSDictionary queryParameters, Boolean secure, boolean includeSessionID) {
	...
	public static String directActionUrl(WOContext context, String host, Integer port, String path, String directActionName, String key, Object value, Boolean secure, boolean includeSessionID) {
		NSDictionary queryParameters = null;
	 ...
	 * @return the constructed direct action URL
	 */
	public static String directActionUrl(WOContext context, String host, Integer port, String path, String directActionName, NSDictionary queryParameters, Boolean secure, boolean includeSessionID) {
