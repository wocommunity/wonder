...
public class ERXResponseRewriter {
	...
	private static Map<WOComponent, NSMutableDictionary> _ajaxPageUserInfos;

	private static Map<WOComponent, NSMutableDictionary> _pageUserInfos;
	...
	static {
		ERXResponseRewriter._pageUserInfos = Collections.synchronizedMap(new WeakHashMap<WOComponent, NSMutableDictionary>());
		ERXResponseRewriter._ajaxPageUserInfos = Collections.synchronizedMap(new WeakHashMap<WOComponent, NSMutableDictionary>());
	}
	 ...
	 */
	public static NSMutableDictionary ajaxPageUserInfo(WOContext context) {
		WOComponent page = context.page();
		NSMutableDictionary pageInfo = ERXResponseRewriter._ajaxPageUserInfos.get(page);
	...
	public static boolean insertInResponseBeforeTag(WOResponse response, WOContext context, String content, String tag, TagMissingBehavior tagMissingBehavior) {
		...
		if (tagIndex >= 0) {
			...
			NSMutableDictionary pageInfo = ERXResponseRewriter.ajaxPageUserInfo(context);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static NSMutableSet resourcesAddedToHead(WOContext context) {
		NSMutableDictionary userInfo = ERXResponseRewriter.ajaxPageUserInfo(context);
		NSMutableSet addedResources = (NSMutableSet) userInfo.objectForKey(ERXResponseRewriter.ADDED_RESOURCES_KEY);
