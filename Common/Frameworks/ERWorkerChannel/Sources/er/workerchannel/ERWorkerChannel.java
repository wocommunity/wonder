...
public class ERWorkerChannel {

    public static final ERXLogger log = ERXLogger.getERXLogger(ERWorkerChannel.class);
    ...
    public ERWorkerChannel(int numberOfThreads, int queueSize) {
