...
public class ERMailSenderTest extends TestCase {
	public List<RelayInfo> relays() {
		...
		relays.add(new RelayInfo(null, "mail.mdimension.com", "mschrag@mdimension.com", "mschrag@mdimension.com"));
		relays.add(new RelayInfo("other", "mailk.mdimension.com", "mschrag@mdimension.com", "mschrag@mdimension.com"));
		return relays;
	}
	...
	protected void testSendMessageNowWithRelay(RelayInfo relay) throws MessagingException {
		...
		assertEquals(relay.host, sentMessages.get(0).transport.getSession().getProperty("mail.smtp.host"));
	}
	...
	public void testSendTwoMessagesDeferredMixedRelays() throws AddressException, MessagingException {
		...
		assertEquals(relays().get(0).host, sentMessages.get(0).transport.getSession().getProperty("mail.smtp.host"));
		assertEquals(relays().get(1).host, sentMessages.get(1).transport.getSession().getProperty("mail.smtp.host"));
	}
