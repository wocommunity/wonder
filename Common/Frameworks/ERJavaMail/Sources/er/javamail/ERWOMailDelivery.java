...
public class ERWOMailDelivery {
    ...
    /** Creates and optionally sends a plain text email.
    	@param fromEmailAddress Originating email address. Required.
    	@param toEmailAddress Destination email address. Required.
    	@param bccEmailAddresses Array of Strings containing additional addressed to BCC. Null OK.
    	@param subject Subject the the message. Null OK.
    	@param message Body the the message. Required.
    	@param sendNow Whether to send the message right away. If you're going to send the message right away, it's faster to set sendNow to true than set it to false and calling {@link #sendEmail(String)} later.
    */
        public
        String
    ...
    */
    ...
    /** Sends the RFC822 mail string created with either {@link #composePlainTextEmail(String,NSArray,NSArray,String,String,boolean)} or {@link #composeComponentEmail(String,NSArray,NSArray,String,WOComponent,boolean)}. It's faster to call either method with the sendNow parameter set to true than to use this method. */
        public
        void
