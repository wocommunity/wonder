...
import java.net.*;  // for URL encoding of strings
import java.text.*; // for number formatting
import java.util.*; // for Enumerations
...
public class PayPalSingleItemHyperlink extends PayPalSingleItemLinkBase {
	...
	if (itemName != null) {
	    sb.append("&item_name=" + URLEncoder.encode(itemName) );
	}
	if (itemNumber != null) {
	    sb.append("&item_number=" + URLEncoder.encode(itemNumber) );
	}
	if (custom != null) {
