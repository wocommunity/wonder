...
//        }
    ...
    public void testDictionaryToXML() {
        ...
        assertEquals("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<NSMutableDictionary type=\"NSMutableDictionary\">\n  <Name>Mike</Name>\n</NSMutableDictionary>\n", output);
...
//        ERXRestRequestNode parsedNode = ERXRestFormat.json().parse(output);
    ...
    public void testPrimitivesToJSON() {
        ...
        String output = ERXRestFormat.json().toString(dict);
        assertEquals("{\"String\":\"Mike\",\"float\":100.5,\"timestamp\":\"2011-03-31T11:08:37Z\",\"boolean\":true,\"short\":100,\"nullValue\":null,\"long\":100000000000,\"double\":100.5,\"date\":\"2011-03-31T11:08:37Z\",\"int\":32}\n", output);
    }
