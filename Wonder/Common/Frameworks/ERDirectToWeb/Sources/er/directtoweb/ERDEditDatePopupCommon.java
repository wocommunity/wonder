...
/* D2WEditDatePopupCommon.java created by bruno on Tue 20-Feb-2001 */
...
public class ERDEditDatePopupCommon extends ERDCustomEditComponent {
    ...
    protected String day;
     ...
     protected static final NSTimestampFormatter DAY_FORMAT =
         new NSTimestampFormatter("%d") /* JC_WARNING - Removed the ommit natural language flag "<e2>".*/;
     protected static final NSTimestampFormatter MONTH_FORMAT =
         new NSTimestampFormatter("%b") /* JC_WARNING - Removed the ommit natural language flag "<e2>".*/;
     protected static final NSTimestampFormatter YEAR_FORMAT =
         new NSTimestampFormatter("%Y") /* JC_WARNING - Removed the ommit natural language flag "<e2>".*/;
     protected static final NSTimestampFormatter TIME_FORMAT =
         new NSTimestampFormatter("%H:%M") /* JC_WARNING - Removed the ommit natural language flag "<e2>".*/;
     protected static final NSTimestampFormatter ALL_FORMAT =
         new NSTimestampFormatter("%d %b %Y") /* JC_WARNING - Removed the ommit natural language flag "<e2>".*/;

     protected static final NSTimestampFormatter ALL_FORMAT_AND_TIME =
         new NSTimestampFormatter("%d %b %Y %H:%M") /* JC_WARNING - Removed the ommit natural language flag "<e2>".*/;
