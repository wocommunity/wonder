...
public abstract class _Studio extends  ERXGenericRecord {
  ...
  // Relationship Keys
  public static final ERXKey<er.distribution.example.client.eo.Movie> MOVIES = new ERXKey<er.distribution.example.client.eo.Movie>("movies");
  ...
  public NSArray<er.distribution.example.client.eo.Movie> movies() {
    return (NSArray<er.distribution.example.client.eo.Movie>)storedValueForKey(_Studio.MOVIES_KEY);
  }

  public NSArray<er.distribution.example.client.eo.Movie> movies(EOQualifier qualifier) {
    return movies(qualifier, null, false);
  }

  public NSArray<er.distribution.example.client.eo.Movie> movies(EOQualifier qualifier, boolean fetch) {
    return movies(qualifier, null, fetch);
  }

  public NSArray<er.distribution.example.client.eo.Movie> movies(EOQualifier qualifier, NSArray<EOSortOrdering> sortOrderings, boolean fetch) {
    NSArray<er.distribution.example.client.eo.Movie> results;
    if (fetch) {
      EOQualifier fullQualifier;
      EOQualifier inverseQualifier = new EOKeyValueQualifier(er.distribution.example.client.eo.Movie.STUDIO_KEY, EOQualifier.QualifierOperatorEqual, this);
      ...
      results = er.distribution.example.client.eo.Movie.fetchMovies(editingContext(), fullQualifier, sortOrderings);
    }
    else {
      results = movies();
      if (qualifier != null) {
  ...
  public void addToMovies(er.distribution.example.client.eo.Movie object) {
    includeObjectIntoPropertyWithKey(object, _Studio.MOVIES_KEY);
  }

  public void removeFromMovies(er.distribution.example.client.eo.Movie object) {
    excludeObjectFromPropertyWithKey(object, _Studio.MOVIES_KEY);
  }

  public void addToMoviesRelationship(er.distribution.example.client.eo.Movie object) {
    if (_Studio.LOG.isDebugEnabled()) {
  ...
  public void removeFromMoviesRelationship(er.distribution.example.client.eo.Movie object) {
    if (_Studio.LOG.isDebugEnabled()) {
  ...
  public er.distribution.example.client.eo.Movie createMoviesRelationship() {
  ...
  public void deleteMoviesRelationship(er.distribution.example.client.eo.Movie object) {
    removeObjectFromBothSidesOfRelationshipWithKey(object, _Studio.MOVIES_KEY);
    editingContext().deleteObject(object);
  }

  public void deleteAllMoviesRelationships() {
    Enumeration<er.distribution.example.client.eo.Movie> objects = movies().immutableClone().objectEnumerator();
