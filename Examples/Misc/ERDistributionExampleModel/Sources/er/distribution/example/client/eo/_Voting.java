...
public abstract class _Voting extends  ERXGenericRecord {
  ...
  public er.distribution.example.client.eo.Movie movie() {
    return (er.distribution.example.client.eo.Movie)storedValueForKey(_Voting.MOVIE_KEY);
  }
  ...
  public static Voting createVoting(EOEditingContext editingContext, er.distribution.example.client.eo.Movie movie) {
