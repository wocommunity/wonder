...
public abstract class _PlotSummary extends  ERXGenericRecord {
  ...
  public webobjectsexamples.businesslogic.eo.Movie movie() {
    return (webobjectsexamples.businesslogic.eo.Movie)storedValueForKey(_PlotSummary.MOVIE_KEY);
  }
  ...
  public static PlotSummary createPlotSummary(EOEditingContext editingContext, webobjectsexamples.businesslogic.eo.Movie movie) {
