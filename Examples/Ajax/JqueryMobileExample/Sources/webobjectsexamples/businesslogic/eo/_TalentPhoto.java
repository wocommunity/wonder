...
public abstract class _TalentPhoto extends  ERXGenericRecord {
  ...
  public webobjectsexamples.businesslogic.eo.Talent talent() {
    return (webobjectsexamples.businesslogic.eo.Talent)storedValueForKey(_TalentPhoto.TALENT_KEY);
  }
  ...
  public static TalentPhoto createTalentPhoto(EOEditingContext editingContext, webobjectsexamples.businesslogic.eo.Talent talent) {
