...
public abstract class _Review extends  ERXGenericRecord {
  ...
  public webobjectsexamples.businesslogic.eo.Movie movie() {
    return (webobjectsexamples.businesslogic.eo.Movie)storedValueForKey(_Review.MOVIE_KEY);
  }
  ...
  public static Review createReview(EOEditingContext editingContext, webobjectsexamples.businesslogic.eo.Movie movie) {
