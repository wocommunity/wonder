...
public abstract class _Voting extends  ERXGenericRecord {
  ...
  public webobjectsexamples.businesslogic.eo.Movie movie() {
    return (webobjectsexamples.businesslogic.eo.Movie)storedValueForKey(_Voting.MOVIE_KEY);
  }
  ...
  public static Voting createVoting(EOEditingContext editingContext, webobjectsexamples.businesslogic.eo.Movie movie) {
