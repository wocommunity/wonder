...
public abstract class _MovieRole extends  ERXGenericRecord {
  ...
  public webobjectsexamples.businesslogic.eo.Movie movie() {
    return (webobjectsexamples.businesslogic.eo.Movie)storedValueForKey(_MovieRole.MOVIE_KEY);
  }
  
  public void setMovie(webobjectsexamples.businesslogic.eo.Movie value) {
  ...
  public webobjectsexamples.businesslogic.eo.Talent talent() {
    return (webobjectsexamples.businesslogic.eo.Talent)storedValueForKey(_MovieRole.TALENT_KEY);
  }
  ...
  public static MovieRole createMovieRole(EOEditingContext editingContext, webobjectsexamples.businesslogic.eo.Movie movie, webobjectsexamples.businesslogic.eo.Talent talent) {
