...
public abstract class _Talent extends  ERXGenericRecord {
  ...
  public webobjectsexamples.businesslogic.eo.TalentPhoto photo() {
    return (webobjectsexamples.businesslogic.eo.TalentPhoto)storedValueForKey(_Talent.PHOTO_KEY);
  }
  
  public void setPhoto(webobjectsexamples.businesslogic.eo.TalentPhoto value) {
  ...
  public NSArray<webobjectsexamples.businesslogic.eo.Movie> moviesDirected() {
    return (NSArray<webobjectsexamples.businesslogic.eo.Movie>)storedValueForKey(_Talent.MOVIES_DIRECTED_KEY);
  }
  ...
  public void deleteAllMoviesDirectedRelationships() {
    Enumeration<webobjectsexamples.businesslogic.eo.Movie> objects = moviesDirected().immutableClone().objectEnumerator();
  ...
  public NSArray<webobjectsexamples.businesslogic.eo.MovieRole> roles() {
    return (NSArray<webobjectsexamples.businesslogic.eo.MovieRole>)storedValueForKey(_Talent.ROLES_KEY);
  }
