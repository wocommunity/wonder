 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://ws.examples.erjaxws.er/", wsdlLocation = "http://localhost:3333/cgi-bin/WebObjects/WebService1.woa/ws/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://ws.examples.erjaxws.er/", "CalculatorService");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://ws.examples.erjaxws.er/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.examples.erjaxws.er/", "CalculatorPort"), Calculator.class, features);
    }
