...
public class SeleniumTestFilesFinder {
	private static final Logger log = Logger.getLogger(SeleniumTestFilesFinder.class);
	
	private final File rootDir;

	public SeleniumTestFilesFinder(File rootDir) {
		this.rootDir = rootDir;
	}
	
	public NSArray<File> findTests() {
