 ...
 * It is used in some other Frameworks, it would be better to add some new
 * 
 * @author ishimoto
 */
public class HttpPostData extends HttpDataObjectBase{

  //***********************************************************
  // Constructor
  //***********************************************************

  public HttpPostData(String hostname) {
    super(hostname);

    setPostOrGet(HTTP_POST);
  }
