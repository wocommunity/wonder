...
public abstract class HttpDataObjectBase extends Object {

  protected static final Logger log = Logger.getLogger(HttpDataObjectBase.class);
  ...
  public HttpDataObjectBase(String hostname) {
  ...
  protected void setPostOrGet(int postOrGet) {
