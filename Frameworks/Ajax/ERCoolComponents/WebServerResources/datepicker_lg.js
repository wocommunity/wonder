/*
        ...
        * Share Alike � If you alter, transform, or build upon this work, you may distribute the resulting work only under the same, similar or a compatible license.
		...
		Added option to hide calendar button, useful when popup is triggered by an onclick handler on the form 
		field (i.e: onClick = datePickerController.show('textFieldId');).
...
var datePickerController = (function datePickerController() {
        ...
        (function() {
                ...
                if(typeof(fdLocale) != "object" && false ) {
                        var head   = document.getElementsByTagName("head")[0] || document.documentElement,
                            ...
                            script;*/
                         	/* Made lang location relative to the script file - dleber - Feb 2010 */
                        	loc    = scriptFiles[scriptFiles.length - 1].src.substr(0, scriptFiles[scriptFiles.length - 1].src.lastIndexOf("/")) + "lang/",
                        	script;
        ...
        datePicker.prototype.createButton = function() {
                ...
                if(this.staticPos || this.hideControl || document.getElementById("fd-but-" + this.id)) { return; };
        ...
        var addDatePicker = function(options) {  
                ...
                var opts = {
                        ...
                        // Do we hide the calendar button,
                        hideControl:!!(options.hideControl),
