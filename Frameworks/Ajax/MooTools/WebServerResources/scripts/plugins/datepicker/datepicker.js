...
var DatePicker = new Class({
	...
	options: { 
		...
		useFadeInOut: !Browser.trident, // dont animate fade-in/fade-out for IE
	...
	initialize: function(attachTo, options) {
		...
		document.addEvent('mousedown', this._close.bind(this));
	},
	...
	onFocus: function(original_input, visual_input) {
		...
		this._show({ left: d.left + this.options.positionOffset.x, top: d.top + d.height + this.options.positionOffset.y }, init_visual_date);
	...
	_show: function(position, timestamp) {
		this.formatMinMaxDates();
		if ($chk(timestamp)) {
	...
	constructPicker: function() {
		...
		new Element('div', { 'class': 'closeButton' }).addEvent('click', this._close.bindWithEvent(this, true)).set('text', 'x').inject(h);
	...
	renderTime: function() {
		...
		new Element('input', { type: 'submit', value: 'OK', 'class': 'ok' })
			.addEvents({
				click: function(e) {
					e.stop();
					this._select(Object.merge(this.dateToObject(this.d), { hours: this.picker.getElement('.hour').get('value').toInt(), minutes: this.picker.getElement('.minutes').get('value').toInt() }));
				}.bind(this)
			})
			.set('maxlength', 2)
			.inject(container);
