...
public abstract class _ERIAttribute extends ERXGenericRecord {
  ...
  public er.indexing.eof.ERIAttributeType indexedAttributeType() {
    return (er.indexing.eof.ERIAttributeType)storedValueForKey(Key.INDEXED_ATTRIBUTE_TYPE);
  }
  public void setIndexedAttributeType(er.indexing.eof.ERIAttributeType value) {
    takeStoredValueForKey(value, Key.INDEXED_ATTRIBUTE_TYPE);
  }

  public er.indexing.eof.ERIEntity indexedEntity() {
    return (er.indexing.eof.ERIEntity)storedValueForKey(Key.INDEXED_ENTITY);
  }
  public void setIndexedEntity(er.indexing.eof.ERIEntity value) {
