...
public class ERXRouteRequestHandler extends WODirectActionRequestHandler {
	 ...
	 */
	public NSArray routesForControllerClass(Class<? extends ERXRouteController> routeController) {
	...
	public void addDefaultRoutes(String entityName, String entityType, boolean numericPKs, Class<? extends ERXRouteController> controllerClass) {
		NSArray existingRoutes = routesForControllerClass(controllerClass);
	...
	public ERXRoute routeForMethodAndPath(String method, String path, NSMutableDictionary/*<String, Object>*/ userInfo) {
		...
		for (Enumeration routeEnum = _routes.objectEnumerator(); routeEnum.hasMoreElements(); ) {
			ERXRoute route = (ERXRoute)routeEnum.nextElement();
	...
	public NSArray getRequestHandlerPathForRequest(WORequest request) {
		...
		try {
			...
			if (matchingRoute != null) {
				...
				String controller = (String)keys.objectForKey(ERXRoute.ControllerKey);
				String actionName = (String)keys.objectForKey(ERXRoute.ActionKey);
