...
public class ERXRouteRequestHandler extends WODirectActionRequestHandler {
	...
	public NSArray<String> getRequestHandlerPathForRequest(WORequest request) {
		NSMutableArray<String> requestHandlerPath = new NSMutableArray<String>();
	...
	@Override
	public WOActionDescription getRequestActionClassAndNameForPath(NSArray requestHandlerPath) {
		...
		return new WOActionDescription(new NSArray<String>(new String[] { requestActionClassName, requestActionName, requestActionClassName }), this);
	}

	@Override
	public WOAction getActionInstance(Class<? extends WOAction> anActionClass, Class<?>[] parameters, Object[] arguments) {
		ERXRouteController actionInstance = (ERXRouteController) super.getActionInstance(anActionClass, parameters, arguments);
		WORequest request = (WORequest) arguments[0];
