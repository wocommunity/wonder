...
public class ERXRouteRequestHandler extends WODirectActionRequestHandler {
	...
	public NSArray getRequestHandlerPathForRequest(WORequest request) {
	 ...
	 @Override
	public WOActionDescription getRequestActionClassAndNameForPath(NSArray<String> requestHandlerPath) {
		return new WOActionDescription(requestHandlerPath.subarrayWithRange(new NSRange(0, 2)), this);
	}
