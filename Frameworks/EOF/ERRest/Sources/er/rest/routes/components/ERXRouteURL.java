...
public class ERXRouteURL extends ERXComponent {
	...
	protected void addQueryParameterForKey(Object value, String key, NSMutableDictionary/*<String, Object>*/ queryParameters) {
		if (value instanceof /*ERXEnterpriseObject*/ERXGenericRecord) {
			queryParameters.setObjectForKey(((/*ERXEnterpriseObject*/ERXGenericRecord) value).primaryKeyInTransaction(), key);
		}
		else if (value != null) {
	...
	public String linkURL() {
		...
		for (Enumeration bindingKeyEnum = bindingKeys().objectEnumerator(); bindingKeyEnum.hasMoreElements(); ) {
			String bindingKey = (String)bindingKeyEnum.nextElement();
		...
		if (existingQueryParameters != null) {
			...
			for (Enumeration keyEnum = existingQueryParameters.keyEnumerator(); keyEnum.hasMoreElements(); ) {
