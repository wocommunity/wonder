...
public enum ERXRestFormat {
	XML(ERXXmlRestResponseWriter.class, ERXXmlRestRequestParser.class), JSON(ERXJSONRestResponseWriter.class, ERXJSONRestRequestParser.class), PLIST(ERXPListRestResponseWriter.class, ERXPListRestRequestParser.class), HTML(null, null);
