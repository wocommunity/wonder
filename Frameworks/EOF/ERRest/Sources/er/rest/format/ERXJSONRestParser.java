...
//	private static ERXRestRequestNode createRequestNodeForJSON(String name, JSON json, boolean rootNode, ERXRestFormat.Delegate delegate) {
...
//	}
	...
	public ERXRestRequestNode parseRestRequest(IERXRestRequest request, ERXRestFormat.Delegate delegate, ERXRestContext context) {
		...
		if (contentString != null && contentString.length() > 0 && !"undefined".equals(contentString)) {
			...
			Object rootJSON = ERXPropertyListSerialization.propertyListFromJSONString(contentString);
			rootRequestNode = ERXPListRestParser.createRequestNodeForObject(null, rootJSON, true, delegate);
		}
		else {
