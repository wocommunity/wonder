...
public class PostgresqlExpression extends JDBCExpression {
  ...
  public static class JoinClause {
    ...
    public int hashCode() { 
      int hash = 1;
      hash = hash * 31 + (table1 == null ? 0 : table1.hashCode());
      hash = hash * 31 + (op == null ? 0 : op.hashCode());
      hash = hash * 31 + (table2 == null ? 0 : table2.hashCode());
      hash = hash * 31 + (joinCondition == null ? 0 : joinCondition.hashCode());
      return hash;
    }
