/*
 ERMailDeliveryPlainHTML.java - Henrique Gomes based on ERMailDeliveryHTML by Camille Troillard - tuscland@mac.com
 */
...
/**
 * This ERMailDelivery subclass is specifically crafted for HTML messages where the the HTML is provided as a string.
 * 
 * @author Henrique Gomes <hmng@farol.pt>
 * @author Camille Troillard <tuscland@mac.com>
 */
public class ERMailDeliveryPlainHTML extends ERMailDelivery {
	...
	public static ERMailDeliveryPlainHTML newMailDelivery() {
	...
	public static interface Factory {
		 ...
		 */
		public ERMailDeliveryPlainHTML newHTMLMailDelivery();
	}
	...
	public static class DefaultFactory implements Factory {
		public ERMailDeliveryPlainHTML newHTMLMailDelivery() {
			return new ERMailDeliveryPlainHTML();
		}
	}
