...
public class _ClassNameComparator extends NSComparator {
	...
	public _ClassNameComparator(NSSelector<EOSortOrdering.Comparison> comparator) {
		super();
	...
	public int compare(Object c1, Object c2) throws NSComparator.ComparisonException {
		if (!(c1 instanceof Class) || !(c2 instanceof Class) || (c1 == null) || (c2 == null))
			throw new NSComparator.ComparisonException("<" + getClass().getName() + 
					" Unable to compare classes. Either one of the arguments is not a Class or is null. Comparison was made with " + c1 + " and " + c2 + "." );
