...
public class NSSet<E> implements Cloneable, Serializable, NSCoding, _NSFoundationCollection, Set<E> {
	...
	private static final long serialVersionUID = -8833684352747517048L;
	...
	public static final NSSet EmptySet = new NSSet<Object>();
	...
	public Iterator<E> iterator() {
		return new _NSJavaSetIterator<E>(objectsNoCopy());
	}
	...
	public Enumeration<E> objectEnumerator() {
		return new _NSCollectionEnumerator<E>(_objects, _flags, count());
	}

	@SuppressWarnings("unchecked")
	protected E[] objectsNoCopy() {
		if (_objectsCache == null) {
			_objectsCache = (E[]) (count() != 0 ? _NSCollectionPrimitives.valuesInHashTable(_objects, _objects, _flags, capacity(), _hashtableBuckets) : _NSCollectionPrimitives.EmptyArray);
		}
	...
	public E[] toArray() {
		E[] currObjects = objectsNoCopy();
		@SuppressWarnings("unchecked")
		E[] objects = (E[]) new Object[currObjects.length];
