...
public class ERXPartial<T extends ERXGenericRecord> {
	 ...
	 * 
	 * @return array of ERXKey(s) for the partial entity attributes
	 */
	 ...
	 * When partial entities are initialized the EOEntity is removed from the model making it impossible to query attributs and relationships later.
	 * 
	 * @return array of ERXKey(s) for the partial entity relationships
	 */
	 ...
	 * When partial entities are initialized the EOEntity is removed from the model making it impossible to query attributs and relationships later.
	 * 
	 * @return array of ERXKey(s) for the partial entity attributes and relationships
	 */
