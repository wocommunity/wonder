...
/**
 * The ERXSession aguments the regular WOSession object by adding a few nice
...
public class ERXSession extends ERXAjaxSession implements Serializable {
	 ...
	 * <code>languages</code> array. See {@link ERXLocalizer} for more
	 * information about using a localizer.
	 * 
	 ...
	 * This is simply a cover method of {@link ERXLocalizer#availableLanguages},
	 * but will be convenient for binding to dynamic elements like language
	 * selector popup.
	 * 
	 ...
	 * language array ({@link ERXLocalizer#availableLanguages}).
	 * <p>
	...
	/**
	 * Simple mutable dictionary that can be used at runtime to stash objects
	 * that can be useful for debugging.
	 * 
	 * @return debugging store dictionary
	 */
	// ENHANCEME: Should perform a check to make sure that the app is not in
	// production mode when this is being used.
	...
	/**
	 * Ensures that the returned editingContext was created with the
	 * {@link ERXEC} factory.
	 * 
	 * @return the session's default editing context with the default delegate
	 *         set.
	 */
	 ...
	 * WorkerThread for this rr loop very useful for logging stuff: assign a log
	 * statement to a log entry. Something useful could be:
