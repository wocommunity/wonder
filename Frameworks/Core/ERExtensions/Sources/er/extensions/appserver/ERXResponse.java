 ...
 * by default from ERXApplication. Also has support for "partials", i.e. in your render tree, you can define a
 * new "partial", where the content will actually get rendered.
 * 
 * @author mschrag
 * @author ak
 */
