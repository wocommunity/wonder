...
public class ERXDatabaseContextMulticastingDelegate extends ERXMulticastingDelegate {
    ...
    public static void addDefaultDelegate(Object newDelegate) {
        ERXDatabaseContextMulticastingDelegate multiDelegate;
         if (EODatabaseContext.defaultDelegate() == null) {
             multiDelegate = newERXDatabaseContextMulticastingDelegate();
         }
         else {
    ...
    /**
     * Factory method to return a hack appropriate to the WO version.  Ick.
     *
     * @return hack appropriate to the WO version
     */
    private static ERXDatabaseContextMulticastingDelegate newERXDatabaseContextMulticastingDelegate() {
    	if (ERXApplication.isWO54()) {
    		return new ERXDatabaseContextMulticastingDelegate54();
    	}
		return new ERXDatabaseContextMulticastingDelegate53();
    }
     ...
     * See ERXDatabaseContextMulticastingDelegate53 and ERXDatabaseContextMulticastingDelegate54 for implementations of this method.
	 */ 
//    /**
...
//     */
//    public NSDictionary databaseContextShouldUpdateCurrentSnapshot(EODatabaseContext dbCtxt, NSDictionary existingSnapshot, NSDictionary fetchedRow, EOGlobalID gid, EODatabaseChannel dbChannel) {
//    	return (NSDictionary)perform("databaseContextShouldUpdateCurrentSnapshot", dbCtxt, existingSnapshot, fetchedRow, gid, dbChannel, existingSnapshot);
//    }
