...
public class NSDictionarySerializer extends AbstractSerializer {
    ...
    public boolean canSerialize(Class clazz, Class jsonClazz)
    {
		return (super.canSerialize(clazz, jsonClazz) ||
				((jsonClazz == null || jsonClazz == JSONObject.class) &&
				 NSDictionary.class.isAssignableFrom(clazz)));
    }
		...
		throws UnmarshallException
    {
        ...
        if(!(java_class.equals("com.webobjects.foundation.NSDictionary") ||
		     java_class.equals("com.webobjects.foundation.NSMutableDictionary") ) )
    ...
    public Object marshall(SerializerState state, Object o) throws MarshallException {
        ...
        try {
            for (Enumeration e = map.keyEnumerator(); e.hasMoreElements(); ) {
                key = e.nextElement();
                Object value = ser.marshall(state, map.objectForKey(key));
