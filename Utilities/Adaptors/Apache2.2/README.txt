...
Yes, it's true!  You can run the WebObjects adaptor on Apache2.2.x.


HOW TO GET STARTED
1. Get Apache2.2.x.  You may use either source, or precompiled binary.
...
3. Set the build variables appropriate to your system's configuration in the file "make.config" and set the adaptors variable to Apache2.2 (see comments in file.)
